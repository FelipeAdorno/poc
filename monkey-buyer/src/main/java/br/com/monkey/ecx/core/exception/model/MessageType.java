...
public enum MessageType {
    ...
    /**
     * This enums are a Type of message error and the users see this,
     * is more beauty use camel case them uppercase.
     */
    ...
    Integration_Error("Error on services integration.");
